...
## Title
Show HN: ToolboxPro – 102 free tools + 2 AI tools that run in your browser

## Body

Zero server-side processing. Your files AND your AI queries never leave your device.

https://trytoolboxpro.com

102 tools including:
- AI Grammar Checker (Transformers.js, runs locally)
- AI Text Summarizer (Transformers.js, runs locally)
...
Built with Next.js 15, Tailwind v4, pdf-lib for PDF, Transformers.js for AI.

All processing — including AI — happens in your browser. No accounts, no uploads, no servers, no API keys.
