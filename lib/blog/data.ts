...
export const blogPosts: BlogPost[] = [
  ...
  // --- Additional blog posts (previously orphaned) ---
  {
    slug: "age-calculator-more-than-birthday",
    title: "Age Calculator: More Than Just Your Birthday",
    description: "Calculate exact age, days between dates, countdown timers, and more.",
    date: "2026-06-26",
    readTime: "9 min read",
    category: "Utilities",
  ...
  },
  {
    ...
    title: "Color Palette Design Guide: Creating Harmonious Color Schemes",
    description: "Learn color theory and create beautiful palettes. Monochromatic, complementary, and more.",
    date: "2026-06-26",
    readTime: "11 min read",
    category: "CSS & Design",
  ...
  {
    slug: "how-to-create-barcode-online",
  ...
  {
    slug: "image-format-comparison-2026",
  ...
  {
    slug: "online-password-security-guide",
  ...
  {
    slug: "text-processing-tools-guide",
    title: "Text Processing Tools Every Writer and Developer Needs",
    description: "Sort, deduplicate, reverse, and transform text with free online tools.",
    date: "2026-06-26",
    readTime: "10 min read",
    category: "Text Tools",
