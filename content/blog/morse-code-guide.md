...
We'll cover the complete history of Morse code, provide reference charts for letters, numbers, and prosigns, and show you how to instantly encode and decode messages using our free [Morse Code Converter tool](/tools/morse-code-converter).
...
- **E** (the most common letter) is a single dot: `·`
- **T** (the second most common) is a single dash: `—`
- **Q** (rarely used) gets four symbols: `— — · —`
...
- **Single element:** E (·), T (—)
- **Two elements:** I (··), A (·—), M (——), N (—·)
- **Three elements:** S (···), U (··—), D (—··), K (—·—)
- **Four elements and beyond:** Practice these last
...
Our free [Morse Code Converter tool](/tools/morse-code-converter) makes encoding and decoding Morse code effortless:

- **Convert text to Morse code** — type any message and see the dot-dash representation instantly
- **Decode Morse code to text** — paste a Morse code sequence and get the readable message
- **Audio playback** — listen to your Morse code message played at adjustable speed
- **Customizable timing** — adjust the speed between 5 and 40 words per minute
- **Supports letters, numbers, and punctuation** — complete character set
...
Use our [Morse Code Converter tool](/tools/morse-code-converter) to practice encoding and decoding messages, and explore the rich history and ongoing relevance of this remarkable communication system.

---

## Related Tools

- [Morse Code Converter](/tools/morse-code-converter) — Encode and decode Morse code messages online
- [Barcode Generator](/tools/barcode-generator) — Create barcodes in multiple formats
- [Caesar Cipher Tool](/tools/caesar-cipher) — Encode and decode Caesar cipher messages
