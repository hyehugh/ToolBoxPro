...
You don't need expensive software like Photoshop to crop images effectively. With the right online tool, you can crop, resize, and format your images in seconds — right from your browser. In this guide, we'll explain why cropping matters, break down aspect ratios and common sizes for different platforms, and show you exactly how to crop images online for free using our [Image Cropper tool](/tools/image-cropper).
...
- **Carousel:** 1080 × 1080 px (1:1) recommended

### Facebook
- **Feed post:** 1200 × 630 px (roughly 1.91:1)
...
### LinkedIn
- **Feed post:** 1200 × 627 px (roughly 1.91:1)
- **Profile picture:** 400 × 400 px (1:1)
- **Banner image:** 1584 × 396 px (roughly 4:1)
...
### Web and General Use
- **Blog featured image:** 1200 × 630 px (roughly 1.91:1)
- **Product image:** 2000 × 2000 px (1:1) for e-commerce
- **Email header:** 600 × 200 px (3:1)
- **Favicon:** 32 × 32 px or 512 × 512 px (1:1)

## How to Crop Images Online: Step-by-Step

Using our [Image Cropper tool](/tools/image-cropper) is simple and fast. Here's how to crop your images:

### Step 1: Upload Your Image

Click the upload button or drag and drop your image into the tool. We support all common image formats:
- **JPEG/JPG** — Best for photographs and web images
- **PNG** — Best for graphics with transparency
- **WebP** — Modern format with excellent compression
- **BMP and GIF** — Also supported
...
- Keep the subject off-center for a more dynamic composition
- Leave breathing room around the subject (don't crop too tightly)
- Check the edges for any distracting elements that should be removed

### Step 4: Preview and Adjust

Before finalizing, preview the cropped image to make sure it looks right. Check that:
- The subject is properly positioned
- No important elements are cut off
- The image looks balanced and professional
- The dimensions match your intended use
...
- **PNG** — Best for graphics and when you need lossless quality
- **WebP** — Best for web use (modern browsers, excellent compression)
...
- For **photographs on the web:** Use JPEG at 80-90% quality for the best balance of quality and file size
- For **graphics and text:** Use PNG to preserve sharp edges
- For **web optimization:** Use WebP for the smallest file size with great quality
...
Our free [Image Cropper](/tools/image-cropper) offers everything you need:

- **Browser-based processing** — your images never leave your device
- **All major formats** — JPEG, PNG, WebP, GIF, and more
- **Preset sizes** for all major social media platforms
- **Custom aspect ratios** and exact pixel dimensions
- **Real-time preview** — see changes as you make them
- **High-quality output** — no compression artifacts from our processing
- **Free for personal and commercial use** — no limits, no watermarks
...
Start cropping your images today with our free [Image Cropper tool](/tools/image-cropper) and see the difference a well-cropped photo can make.

---

## Related Tools

- [Image Cropper](/tools/image-cropper) — Crop images online for free with preset sizes
- [Image Resizer](/tools/image-resizer) — Resize images to any dimension
- [QR Code Generator](/tools/qr-code-generator) — Generate QR codes for sharing
- [Text to Image](/tools/text-to-image) — Create images from text
